                ...
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-messages">
                        <li>
                            <div className="dropdown-messages-box">
                                <a href="profile.html" className="pull-left">
                                    <img alt="imagedfdfd" className="img-circle" src="img/a7.jpg" />
                                </a>
                        ...
                        <li>
                            <div className="dropdown-messages-box">
                                <a href="profile.html" className="pull-left">
                                    <img alt="imagedfdf" className="img-circle" src="img/a4.jpg" />
                                </a>
                                <div className="media-body ">
                        ...
                        <li>
                            <div className="dropdown-messages-box">
                                <a href="profile.html" className="pull-left">
                                    <img alt="imagergrtgr" className="img-circle" src="img/profile.jpg" />
                                </a>
                                <div className="media-body ">
